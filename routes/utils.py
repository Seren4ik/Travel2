...
def dfs_paths(graph, start, goal):
    ...
    из одного города в другой. Варианты посещения
...
def get_routes(request, form) -> dict:
    ...
    """Поиск маршрутов через выбранные города"""
    ...
    if cities:
        ...
        if not right_ways:
            raise ValueError('Маршрут, через эти города не найден')
    else:
        right_ways = all_ways

    """Поиск маршрутов по заданному времени"""
    routes = []
    all_routes = {}
    for q in qs:
    ...
    """Сортировка по времени маршрутов"""
